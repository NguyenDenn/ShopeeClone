...
export default function RatingStart({ queryConfig }: Props) {
  ...
  const handleFilterStart = (rating_filter: number) => {
    navigate({
      pathname: path.home,
              ...
              {Array(5)
                ...
                .map((_, indexStart) => {
                  if (indexStart < 5 - index) {
                    return (
                      <svg viewBox='0 0 9.5 8' className='w-3 h-4 mr-1' key={indexStart}>
                        <defs>
                  ...
                  return (
                    <svg viewBox='0 0 30 30' className='w-3 h-4 mr-1' key={indexStart}>
                      <defs>
