      ...
      <div className='bg-white shadow rounded-sm hover:translate-y-[-0.0625rem] hover:shadow-sm duration-100 transition-transform overflow-hidden'>
        <div className='w-full pt-[100%] relative'>
          <img
            ...
            src='https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lq7q2fcxl92vae_tn'
          />
        </div>
        <div className='p-2 overflow-hidden'>
          <div className='min-h-[2rem] line-clamp-2 text-xs'>
            Áo khoác nỉ hoodie zip nam nữ local brand unisex bigsize bông dầy dặn dây kéo có mũ to mặc cặp đôi Pandax
            Polime Race
          </div>
