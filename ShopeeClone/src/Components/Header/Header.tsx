...
export default function Header() {
  ...
  return (
    <div className='pb-5 pt-2 bg-oranges '>
            ...
            renderPopover={
              <div className='bg-white  shadow-md rounded-sm  border-gray-200'>
                <div className='flex flex-col py-2 px-3'>
                  <button className='py-2 px-3 hover:text-oranges'>Vietnamese</button>
                  <button className='py-2 px-3 hover:text-oranges'>English</button>
                </div>
              </div>
            }
          >
            ...
            <span className='mx-1 text-white'>Vietnamese </span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
              strokeWidth={1.5}
              stroke='currentColor'
              className='w-6 h-6 mr-5 text-white'
            >
                          ...
                          {purchasesInCart.slice(0, MAX_PURCHASES).map((purchases) => (
                            <div className='mt-2 py-2 px-2 flex hover:bg-gray-200' key={purchases._id}>
                              ...
                              <div className='ml-2 flex-shrink-0'>
                                <span className='text-oranges'>₫{formatCurrency(purchases.price)}</span>
                              </div>
                            </div>
                          ))}
                        </div>
